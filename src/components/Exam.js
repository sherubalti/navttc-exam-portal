...
//     endDate: new Date('2025-12-28T1:30:00'),   // 28th Dec 2025, 1:30 PM
...
//               <p>Exam Window: 12:30 PM to 1:30 PM</p>
...
//             <p><strong>Time Window:</strong> 12:30 PM to 1:30 PM</p>
...
//             <li>You must complete before 1:30 PM</li>
//             <li>Each question has 4 options</li>
//             <li>You cannot go back once submitted</li>
//             <li>Exam will auto-submit when time expires</li>
//             <li><strong>Warning:</strong> Switching tabs/windows will result in automatic submission after 3 violations</li>
...
//               Scheduled: 28 Dec 2025, 12:30 PM - 1:30 PM
//             </p>
//           </div>
//           <div className="timer">
...
const Exam = ({ user }) => {
  ...
  const EXAM_SCHEDULE = {
    startDate: new Date('2025-12-26T20:26:00'), // Today, 8:26 PM (for testing)
    endDate: new Date('2025-12-26T21:30:00'),   // Today, 9:30 PM (for testing)
    duration: 30 * 60 // 30 minutes in seconds
  };
